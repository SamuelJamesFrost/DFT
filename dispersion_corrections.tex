	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				xtick=data,width=200pt, x tick label style={rotate=90},ylabel=Bulk Modulus (GPa), xlabel=DFT Method,     ylabel near ticks,
				...
				\end{axis}
			\end{tikzpicture}
			\caption{Bulk modulus of Palladium for varius DFT functionals and their dispersion corrections\cite{Ilawe2015}}
			\label{fig:bulk}
		...
		\begin{tikzpicture}
			\begin{axis}[
				symbolic x coords={Expt., LDA, PBE, PBE-D2, PBE-D3, vdW-DF2},
				xtick=data,width=200pt, x tick label style={rotate=90},ylabel=Cohesive Energy (eV), xlabel=DFT Method,     ylabel near ticks,
				x label style={at={(axis description cs:0.5,-0.2)},anchor=north},
				y label style={at={(axis description cs:-0.2,0.85)},anchor=east},
				]
				\addplot[ybar,fill=lightgray] coordinates {
				...
				\end{axis}
			\end{tikzpicture}
			\caption{Cohesive energy of Palladium for varius DFT functionals and their dispersion corrections\cite{Ilawe2015}}
			\label{fig:cohesive}
			\vspace{-10pt}
	\end{figure}
