...
\begin{document}
	...
	\begin{@twocolumnfalse}
		...
		\begin{abstract}
			This is an old version, please see dispersion\_corrections.pdf
		\end{abstract}
		\centering\noindent\rule{0.9\textwidth}{0.4pt}\\
		\vspace{1cm}
	\end{@twocolumnfalse}]
	...
	%*****************************************
	 %This kovacs one only uses D3, which could be useful if we're struggling
	...
	%*************** SHOULD MAYBE REORDER THE PAPER TO HAVE APPLICATIONS AT THE END, AND JUST HAVE IT BE DIFFERENT KINDS I.E. ADSORPTION TO METAL SURFACES, THAT WAY THERE'S NO REPEPTITION AND WE CAN COMPARE THINGS BETTER, CONSIDER!!!
